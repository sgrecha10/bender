...
QUOTER_ABI = json.loads((BASE_DIR / 'abis/quoter.json').read_text())

ROUTER_ADDRESS = Web3.to_checksum_address('0xE592427A0AEce92De3Edee1F18E0157C05861564')
ROUTER_ABI = json.loads((BASE_DIR / 'abis/router.json').read_text())

POSITION_MANAGER_ADDRESS = Web3.to_checksum_address('0xC36442b4a4522E871399CD717aBDD847Ab11FE88')
POSITION_MANAGER_ABI = json.loads((BASE_DIR / 'abis/position_manager.json').read_text())
